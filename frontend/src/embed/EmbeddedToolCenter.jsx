...
function ToolPage({ route, onNavigate, assetBaseUrl, companionClient }) {
  ...
  return (
    <I18nProvider language={language} config={{
      ...
      <div className="tool-site pp-tools-embed" data-tool-route={normalizedRoute}>
        <ToolPage route={normalizedRoute} onNavigate={onNavigate} assetBaseUrl={assetBaseUrl} companionClient={deltaClient} />
      </div>
    </I18nProvider>
  );
}
